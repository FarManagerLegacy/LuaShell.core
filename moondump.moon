-- https://github.com/leafo/moonscript/wiki/Pretty-Table-Dumper
------ moondump.moon ----
...
-- @return a string
dump = (t,options) ->
    if t==nil return "nil" -- ADDED by jd
    options = options or {}
...
---------------
if _cmdline==""
    print "Table dumper with compact output, see usage details in file comments"
elseif _cmdline
